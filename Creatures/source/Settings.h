...
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_ZERO_GRAVITY;
extern const float CREATURE_BRAIN_BIAS_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_ZERO_GRAVITY;
extern const float CREATURE_BRAIN_LINK_WEIGHT_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_ZERO_GRAVITY;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MIN_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_CHANCE_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MIN_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_STRENGTH_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MIN_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_ZERO_GRAVITY_MIN_GRAVITY;


extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_CHANCE_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_STRENGTH_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_ZERO_GRAVITY_MIN_GRAVITY;


extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_CHANCE_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_STRENGTH;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_STRENGTH_MIN_GRAVITY;

extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_ZERO_GRAVITY;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_ZERO_GRAVITY_MIN_GRAVITY;

// Creature body mutation settings
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_STRENGTH;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_STRENGTH;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_STRENGTH;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_DEVICE_JITTER_ADHESION_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_ADHESION_ANGLE_STRENGTH;
extern const float CREATURE_MUTATION_DEVICE_JITTER_ADHESION_ANGLE_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_MEAT_PRIORITY_JITTER_CHANCE;
extern const float CREATURE_MUTATION_MEAT_PRIORITY_JITTER_STRENGTH;
extern const float CREATURE_MUTATION_MEAT_PRIORITY_JITTER_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_CHANCE;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_STRENGTH;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_ZERO_GRAVITY;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_CHANCE;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_STRENGTH;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_ZERO_GRAVITY;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_INITIAL_STICKYNESS;
...
extern TweakableFloatSetting SIMULATION_OFFSPRING_CREATURE_INITIAL_STICKYNESS;
...
extern TweakableFloatSetting CREATURE_DEVICE_ADHESION_EFFECTIVENESS;


extern TweakableFloatSetting CREATURE_MEAT_CONSUMPTION_EFFECTIVENESS_MULTIPLIER_ON_PRIORITY_MATCH;
extern TweakableFloatSetting CREATURE_MEAT_CONSUMPTION_EFFECTIVENESS_MULTIPLIER_ON_PRIORITY_MISMATCH;
extern TweakableFloatSetting CREATURE_MEAT_CONSUMPTION_EFFECTIVENESS_EXPONENT_ON_PRIORITY_MATCH;
extern TweakableFloatSetting CREATURE_MEAT_CONSUMPTION_EFFECTIVENESS_EXPONENT_ON_PRIORITY_MISMATCH;
