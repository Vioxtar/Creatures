...
extern const float UI_DEARIMGUI_WINDOW_SMOOTH_RESIZE_RATE;
extern const float UI_DEARIMGUI_WINDOW_CLOSING_PIXEL_SIZE_THRESHOLD;

extern const float UI_CREATURE_TRACKER_MIN_WINDOW_WIDTH;
extern const float UI_CREATURE_TRACKER_MIN_WINDOW_HEIGHT;
...
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_POSITIVE_VALUE_COLOR_R;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_POSITIVE_VALUE_COLOR_G;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_POSITIVE_VALUE_COLOR_B;

extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NEGATIVE_VALUE_COLOR_R;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NEGATIVE_VALUE_COLOR_G;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NEGATIVE_VALUE_COLOR_B;

extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NODE_BACKGROUND_COLOR_R;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NODE_BACKGROUND_COLOR_G;
extern const unsigned int UI_CREATURE_TRACKER_BRAIN_NODE_BACKGROUND_COLOR_B;

extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEUTRAL_COLOR_R;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEUTRAL_COLOR_G;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEUTRAL_COLOR_B;

extern const float UI_CREATURE_TRACKER_BRAIN_LINK_MAX_WIDTH;

extern const float UI_CREATURE_TRACKER_BRAIN_LINK_WEIGHT_MAX_ABS_NORMALIZER;

extern const unsigned int UI_CREATURE_TRACKER_PLOT_NUM_OF_VALUES;
...
extern const uint16_t TECH_BRAIN_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_X;
extern const uint16_t TECH_BRAIN_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_Y;
...
extern const uint16_t CREATURE_BRAIN_NUM_OF_TEMPORALS;
...
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_MAX_ABS;

extern const float CREATURE_BRAIN_ACTIVATION_EXPONENT_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT;
extern const float CREATURE_BRAIN_BIAS_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_PERCENTAGE_EXPONENT;
extern const float CREATURE_BRAIN_LINK_WEIGHT_MAX_ABS;
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_PERCENTAGE_EXPONENT;
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_CHANCE_FOR_NON_NEUTRAL_VALUE;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_CHANCE_FOR_NON_NEUTRAL_VALUE;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_CHANCE_FOR_NON_NEUTRAL_VALUE;

// Creature brain mutation settings

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_MAX_ABS;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_MAX_ABS;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_LINK_WEIGHT_CHANCE;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_LINK_WEIGHT_MAX_ABS;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_LINK_WEIGHT_PERCENTAGE_EXPONENT;

// Creature body mutation settings
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_MAX_ABS;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_MAX_ABS;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_CHANCE;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_MAX_ABS;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_CHANCE;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_MAX_ABS;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_PERCENTAGE_EXPONENT;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_CHANCE;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_MAX_ABS;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_PERCENTAGE_EXPONENT;
...
extern TweakableIntegerSetting TRAINING_WHEELS_GENERATION_UPPER_THRESHOLD;
extern TweakableFloatSetting TRAINING_WHEELS_OFFSPRING_COUNT_SCORE_WEIGHT;
extern TweakableFloatSetting TRAINING_WHEELS_GENERATION_SCORE_WEIGHT;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_MOVING_SPAWN_MAX_VELOCITY_LENGTH;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_MOVING_SPAWN_RANDOM_VELOCITY_MAGNITUDE;
...
// UI settings
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEGATIVE_VALUE_COLOR_R;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEGATIVE_VALUE_COLOR_G;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_NEGATIVE_VALUE_COLOR_B;

extern const float UI_CREATURE_TRACKER_BRAIN_LINK_POSITIVE_VALUE_COLOR_R;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_POSITIVE_VALUE_COLOR_G;
extern const float UI_CREATURE_TRACKER_BRAIN_LINK_POSITIVE_VALUE_COLOR_B;