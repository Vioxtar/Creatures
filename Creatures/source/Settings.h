...
extern const uint16_t TECH_BRAIN_NEW_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_X;
extern const uint16_t TECH_BRAIN_NEW_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_Y;
