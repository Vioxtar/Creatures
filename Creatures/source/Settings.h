...
extern const float CREATURE_BRAIN_NEW_MAX_ABS_ACTIVATION_EXPONENT;
extern const float CREATURE_BRAIN_NEW_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT;
extern const float CREATURE_BRAIN_NEW_MAX_ABS_BIAS;
extern const float CREATURE_BRAIN_NEW_BIAS_PERCENTAGE_EXPONENT;
extern const float CREATURE_BRAIN_NEW_MAX_LINK_WEIGHT;
extern const float CREATURE_BRAIN_NEW_MAX_LINK_WEIGHT_PERCENTAGE_EXPONENT;
