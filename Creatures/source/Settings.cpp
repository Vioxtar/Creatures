...
extern const uint16_t TECH_BRAIN_NEW_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_X = 4;
extern const uint16_t TECH_BRAIN_NEW_FORWARD_PROPAGATE_WORKGROUP_LOCAL_SIZE_Y = 64;
...
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.4;
...
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.0;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_MAX_ABS = 2.0;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_PERCENTAGE_EXPONENT = 50.0;

extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.0;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_MAX_ABS = 10.0;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 10.0;

// Creature brain mutation settings
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_MAX_ABS = 2.0;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_MAX_ABS = 5.0;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 10.0;

// Creature body mutation settings
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_PERCENTAGE_EXPONENT = 10.0;
...
extern TweakableFloatSetting SIMULATION_VELOCITY_DOWNSCALE = { 0.9925, 0.0, 1.0 };
...
extern TweakableFloatSetting CREATURE_DEVICE_SPIKE_VERSUS_LIFE_EFFECTIVENESS = { 0.04, 0.0, 1.0 };
