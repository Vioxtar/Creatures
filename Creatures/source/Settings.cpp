...
extern const uint16_t CREATURE_BRAIN_NUM_OF_TEMPORALS = 4;
...
extern const float CREATURE_BRAIN_BIAS_MAX_ABS = 1.0;
extern const float CREATURE_BRAIN_LINK_WEIGHT_MAX_ABS = 5.0;

extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 0.5;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_PERCENTAGE_EXPONENT = 10.0;
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_PERCENTAGE_EXPONENT = 30.0;

// Creature brain mutation settings

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_MAX_ABS = 1.0;
...
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_CHANCE = 0.01;
