...
extern const unsigned int TECH_CREATURES_SUPPORTED_ON_INIT_BUFFER_PREALLOCATION = 25000;

extern const GLenum TECH_SSBO_USAGE = GL_STATIC_DRAW;

extern const GLbitfield TECH_CREATURE_ATTRIBUTE_BUFFER_FLAGS = GL_DYNAMIC_STORAGE_BIT | GL_MAP_READ_BIT | GL_MAP_WRITE_BIT;

extern const GLbitfield TECH_CREATURE_LIST_BUFFER_FLAGS = GL_DYNAMIC_STORAGE_BIT | GL_MAP_READ_BIT | GL_MAP_WRITE_BIT | GL_MAP_PERSISTENT_BIT | GL_MAP_COHERENT_BIT;
extern const GLbitfield TECH_CREATURE_LIST_MAPPING_FLAGS = GL_MAP_PERSISTENT_BIT | GL_MAP_WRITE_BIT | GL_MAP_READ_BIT | GL_MAP_COHERENT_BIT;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_SPAWN_RATE = { 100, 0.0, 50.0 };
