...
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_MAX_ABS = 10.0;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_CONSTANT_SPAWN_RATE = { 3.05, 0.0, 50.0 };
