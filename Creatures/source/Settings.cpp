...
extern const float CREATURE_BRAIN_FIRSTGEN_LINK_WEIGHT_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.3;
...
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.3;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_MAX_ABS = 1.0;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_PERCENTAGE_EXPONENT = 2.0;

extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.3;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_MAX_ABS = 1.0;
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 1.0;


// Creature brain mutation settings
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_CHANCE = 0.001;
...
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 2.0;
...
extern TweakableIntegerSetting EVOLUTION_INCUBATION_TRAINING_WHEELS_GENERATION_UPPER_THRESHOLD = { 3, 0, 100 };
extern TweakableFloatSetting EVOLUTION_INCUBATION_TRAINING_WHEELS_OFFSPRING_COUNT_SCORE_WEIGHT = { 0.25, 0.0, 1.0 };
extern TweakableFloatSetting EVOLUTION_INCUBATION_TRAINING_WHEELS_GENERATION_SCORE_WEIGHT = { 0.5, 0.0, 1.0 };
