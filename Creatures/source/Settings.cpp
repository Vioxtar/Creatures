...
extern const float CREATURE_BRAIN_NEW_ACTIVATION_EXPONENT_MAX_ABS = 10.0;
extern const float CREATURE_BRAIN_NEW_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 4.0;

extern const float CREATURE_BRAIN_NEW_BIAS_MAX_ABS = 1.0;
extern const float CREATURE_BRAIN_NEW_BIAS_PERCENTAGE_EXPONENT = 2.0;

extern const float CREATURE_BRAIN_NEW_LINK_WEIGHT_MAX_VAL = 1.0;
extern const float CREATURE_BRAIN_NEW_LINK_WEIGHT_PERCENTAGE_EXPONENT = 1.0;

// Creature brain mutation settings
extern const float CREATURE_MUTATION_BRAIN_CHANGE_MIDLEVELS_CHANCE = 0.001;

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_BIAS_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BRAIN_CHANGE_SINGLE_LINK_WEIGHT_PERCENTAGE_EXPONENT = 1.0;

// Creature body mutation settings
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SPIKE_ANGLE_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_SHIELD_ANGLE_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_DEVICE_CHANGE_FEEDER_ANGLE_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_PATTERN_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_CHANCE = 0.0025;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_CHANGE_SKIN_HUE_PERCENTAGE_EXPONENT = 1.0;
...
extern TweakableFloatSetting SIMULATION_SPACE_WIDTH = { 500, 1, 2000 };
extern TweakableFloatSetting SIMULATION_SPACE_HEIGHT = { 500, 1, 2000 };
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_OSCILLATE_UP_SPAWN_RATE = { 3.0, 0.0, 100.0 };
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_OSCILLATE_DOWN_SPAWN_RATE = { 1.0, 0.0, 100.0 };
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_OSCILLATE_STEP = { 0.002, 0.0, 10.0 };
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_OSCILLATE_SPAWN_RATE_EXPONENT = { 15.0, 0.0, 10.0 };
...
extern TweakableFloatSetting SIMULATION_OFFSPRING_CREATURE_INITIAL_ENERGY = { 2.0, 0.0, 10.0 };
...
extern TweakableFloatSetting CREATURE_REPRODUCTION_ENERGY_THRESHOLD = { 2.5, 0.0, 1.0 };
...
extern TweakableFloatSetting CREATURE_DEATH_MEAT_ROT_RATE = { 0.001, 0.0, 1.0 };
