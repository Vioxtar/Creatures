...
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_CHANCE_EXPONENT = 3.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_LINK_WEIGHT_MAX_ABS = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_LINK_WEIGHT_PERCENTAGE_EXPONENT = 1.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_MAX_ABS = 5.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_BIAS_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_SINGLE_ACTIVATION_EXPONENT_PERCENTAGE_EXPONENT = 2.0;


// Creature body mutation settings
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SPIKE_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_JITTER_SHIELD_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_MAX_ABS = 1.0;
extern const float CREATURE_MUTATION_DEVICE_JITTER_FEEDER_ANGLE_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_PATTERN_PERCENTAGE_EXPONENT = 10.0;

extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_CHANCE = 0.01;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_MAX_ABS = 0.1;
extern const float CREATURE_MUTATION_BODY_JITTER_SKIN_HUE_PERCENTAGE_EXPONENT = 10.0;
