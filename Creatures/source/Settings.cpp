...
extern const float CREATURE_BRAIN_FIRSTGEN_ACTIVATION_EXPONENT_ZERO_GRAVITY = 1.0;

extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_CHANCE_FOR_NON_NEUTRAL_VALUE = 0.25;
extern const float CREATURE_BRAIN_FIRSTGEN_BIAS_MAX_ABS = 5.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_STRENGTH_MIN_GRAVITY = 5.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_ZERO_GRAVITY_MIN_GRAVITY = 10.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_STRENGTH_MIN_GRAVITY = 5.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_ZERO_GRAVITY_MIN_GRAVITY = 10.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_STRENGTH_MIN_GRAVITY = 5.0;
...
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_ZERO_GRAVITY_MIN_GRAVITY = 10.0;
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_CONSTANT_SPAWN_RATE = { 0.025, 0.0, 50.0 };
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_MOVING_SPAWN_RANDOM_VELOCITY_MAGNITUDE = { 0.00, 0.0, 10.0 };
...
extern TweakableFloatSetting CREATURE_MAX_ADHESION = { 0.01, 0.0, 1.0 };
extern TweakableFloatSetting CREATURE_ADHESION_INTERPOLATION_RATE = { 0.1, 0.001, 1.0 };
...
extern TweakableFloatSetting CREATURE_FORWARD_MOVEMENT_EFFECTIVENESS = { 0.004, 0.0, 1.0 };
extern TweakableFloatSetting CREATURE_BACKWARD_MOVEMENT_EFFECTIVENESS = { 0.001, 0.0, 1.0 };
extern TweakableFloatSetting CREATURE_STRAFE_MOVEMENT_EFFECTIVENESS = { 0.001, 0.0, 1.0 };
...
extern const uint16_t CREATURE_BRAIN_NUM_OF_OUTPUTS = 17 + CREATURE_BRAIN_NUM_OF_TEMPORALS;
