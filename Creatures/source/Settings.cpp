...
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_CHANCE = 0.5;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_CHANCE_MIN_GRAVITY = 3.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MIN_STRENGTH = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_STRENGTH = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_STRENGTH_MIN_GRAVITY = 2.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MIN_ZERO_GRAVITY = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_MAX_ZERO_GRAVITY = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_LINK_WEIGHT_ZERO_GRAVITY_MIN_GRAVITY = 2.0;


extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_CHANCE = 0.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_CHANCE = 0.5;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_CHANCE_MIN_GRAVITY = 3.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_STRENGTH = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_STRENGTH = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_STRENGTH_MIN_GRAVITY = 2.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MIN_ZERO_GRAVITY = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_MAX_ZERO_GRAVITY = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_BIAS_ZERO_GRAVITY_MIN_GRAVITY = 2.0;


extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_CHANCE = 0.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_CHANCE = 0.5;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_CHANCE_MIN_GRAVITY = 3.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_STRENGTH = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_STRENGTH = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_STRENGTH_MIN_GRAVITY = 2.0;

extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MIN_ZERO_GRAVITY = 0.1;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_MAX_ZERO_GRAVITY = 2.0;
extern const float CREATURE_MUTATION_BRAIN_JITTER_ACTIVATION_EXPONENT_ZERO_GRAVITY_MIN_GRAVITY = 2.0;
...
extern TweakableFloatSetting SIMULATION_VELOCITY_DOWNSCALE = { 0.9975, 0.0, 1.0 };
...
extern TweakableFloatSetting SIMULATION_FIRSTGEN_CREATURE_MOVING_SPAWN_RANDOM_VELOCITY_MAGNITUDE = { 0.0, 0.0, 10.0 };
