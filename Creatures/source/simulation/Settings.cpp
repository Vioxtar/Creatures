...
void SimulationSettings_Init()
{
	...
	SimulationSettings_SetFloat(SIM_SETTINGS.SIMULATION_WIDTH, 150);

	SIM_SETTINGS.SIMULATION_HEIGHT.min = 5;
	SIM_SETTINGS.SIMULATION_HEIGHT.max = 300;
	SimulationSettings_SetFloat(SIM_SETTINGS.SIMULATION_HEIGHT, 150);
	...
	SimulationSettings_SetFloat(SIM_SETTINGS.MAX_CREATURE_SENSE_RADIUS, 0.1);
}